...
namespace WT.Application.Contracts
{
    ...
    public interface IAccountRepository
    {
        ...
        // NEW: Hard delete (permanent) with reassignment of trails to system account
        Task<BaseAPIResponseDTO> HardDeleteUserAsync(Guid userId, CancellationToken cancellationToken);
