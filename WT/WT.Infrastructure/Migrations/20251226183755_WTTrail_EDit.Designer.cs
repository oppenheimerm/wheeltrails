...
namespace WT.Infrastructure.Migrations
{
    ...
    [Migration("20251226183755_WTTrail_EDit")]
    partial class WTTrail_EDit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WT.Domain.Entity.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("ProfileUsernameCreatedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ProfileUsernameCreatedAt")
            ...
            modelBuilder.Entity("WT.Domain.Entity.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WT.Domain.Entity.Comment", b =>
                {
                    b.HasOne("WT.Domain.Entity.WTTrail", "Trail")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("WT.Domain.Entity.WTTrail", b =>
                {
                    ...
                    b.OwnsMany("WT.Domain.Geo.WTPointOfInterest", "PointsOfInterest", b1 =>
                        {
                            ...
                            b1.ToTable("TrailPointsOfInterest", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("TrailId");

                            b1.OwnsOne("WT.Domain.Geo.WTLatLng", "Location", b2 =>
                                {
                    ...
                    b.OwnsOne("WT.Domain.Geo.WTLatLng", "Start", b1 =>
                        {
                            b1.Property<Guid>("WTTrailId")
                                .HasColumnType("uniqueidentifier");
